...
<main>
    ...
    <div class="container mx-auto flex" style="padding-bottom: 6.5rem;">
        <div class="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 justify-between max-w-6xl mx-auto space-x-4 flex-nowrap">
            <?php 
            $args = array(
                'post_type' => 'product',
                'posts_per_page' => 4,
