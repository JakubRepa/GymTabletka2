...
<main>
    ...
    <div class="container flex justify-between max-w-full mx-auto space-x-4 flex-nowrap" style="padding-bottom: 6.5rem;">
    <?php 
        $args = array(
            'post_type' => 'product',
            'posts_per_page' => 4,
        ...
        if ($loop->have_posts()) : 
            while ($loop->have_posts()) : $loop->the_post();
                ...
                <div class="text-center">
                    <div class="bg-[#F0F2F5] w-32 h-44 flex items-center justify-center">
