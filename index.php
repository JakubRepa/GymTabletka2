...
<main>
    ...
    <div class="container flex flex-wrap justify-between max-w-6xl mx-auto space-y-4 md:space-y-0 md:space-x-4" style="padding-bottom: 6.5rem;">
    <?php 
        $args = array(
            'post_type' => 'product',
            'posts_per_page' => 4,
        ...
        if ($loop->have_posts()) : 
            while ($loop->have_posts()) : $loop->the_post();
                global $product;
                ?>
                <div class="w-full sm:w-full md:w-1/2 lg:w-1/4 text-center">
